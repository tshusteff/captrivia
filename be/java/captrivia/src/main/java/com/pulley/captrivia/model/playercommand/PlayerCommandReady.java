...
//        E
public class PlayerCommandReady extends PlayerCommandType {
    UUID game_id;

    public PlayerCommandReady() {
    }

    public PlayerCommandReady(UUID game_id) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PlayerCommandReady)) return false;
        PlayerCommandReady that = (PlayerCommandReady) o;
